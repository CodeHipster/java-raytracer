...
public class UnitVectorTest {
    ...
    @Test
    public void test(){
        UnitVector unitVector = new UnitVector(1.0, 2.0, 4.0);
    ...
    @Test
    public void testDot(){
        UnitVector unitVector1 = new UnitVector(1, 1, 0); //45 degrees
        UnitVector unitVector2 = new UnitVector(1, 0, 0); //0 degrees
